...
const FilterSort = () => {
  return (
    <section className="z-[50] sticky py-2 lg:pt-4  lg:-translate-y-4 top-16 lg:top-20  w-full flex items-center bg-gradient-to-b from-[#f1f5f9] via-[#f1f5f9] to-[90%] to-white/20 gap-4 ">
      {/* Filter */}
