...
const Section = () => {
  ...
  return (
    <aside className={`fixed z-[100] md:z-[0] ${showSection ?" translate-x-0":"translate-x-[100%] md:translate-x-0"} top-20 right-0 p-4 md:p-0 md:sticky md:top-[5rem] w-[95%] max-w-[350px] md:w-[30%] h-fit flex flex-col gap-6 bg-white md:bg-transparent border-1 border-gray-300 md:border-transparent transition-transform duration-300 ease-in-out`}>
      ...
      <AnswerDialog isAddAnsOpen={isAddAnsOpen} setIsAddAnsOpen={setIsAddAnsOpen} />
      <TopQuestions />
      <WordFilter />
    </aside>
  );
